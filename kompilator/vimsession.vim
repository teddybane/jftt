...
nnoremap <silent> <SNR>40_QAToolsToggle :call phpqa#QAToolsToggle()
nnoremap <silent> <SNR>40_CodeCoverageToggle :call phpqa#CodeCoverageToggle()
...
badd +2 kor.y
badd +38 Makefile
badd +2 run_vimsession.sh
args kor.lex kor.y Makefile run_vimsession.sh kor.h
edit kor.h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 60 - ((40 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 25 - ((0 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
