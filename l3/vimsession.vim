...
nnoremap <silent> <SNR>36_CodeCoverageToggle :call phpqa#CodeCoverageToggle()
nnoremap <silent> <SNR>36_QAToolsToggle :call phpqa#QAToolsToggle()
...
nnoremap <silent> <SNR>42_QAToolsToggle :call phpqa#QAToolsToggle()
nnoremap <silent> <SNR>42_CodeCoverageToggle :call phpqa#CodeCoverageToggle()
...
badd +1 ../mfcalc/mf.y
badd +1 ../l2z4.lex
badd +1 ../mfcalc/calc.h
badd +1 calc.h
badd +55 tst.calc_h.c
badd +12 _Makefile
badd +1 _calc.y\!
badd +1 Makefile
badd +1 main.cc
badd +1 plik_testowy
badd +1 calc.lex
badd +116 przed_net_nawias_calc.y
badd +1 _calc.h
badd +1 calc.y
args _calc.y
edit calc.y
...
setlocal tabstop=8
setlocal tags=~/projekty/jftt/.git/yacc.tags,~/projekty/jftt/.git/tags,./tags,./TAGS,tags,TAGS
...
silent! normal! zE
let s:l = 139 - ((18 * winheight(0) + 21) / 42)
...
setlocal tabstop=8
setlocal tags=~/projekty/jftt/.git/lex.tags,~/projekty/jftt/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal tabstop=8
setlocal tags=~/projekty/jftt/.git/cpp.tags,~/projekty/jftt/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 134 - ((25 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
134
...
setlocal tabstop=8
setlocal tags=~/projekty/jftt/.git/c.tags,~/projekty/jftt/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal tabstop=8
setlocal tags=~/projekty/jftt/.git/make.tags,~/projekty/jftt/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 77 - ((15 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
77
normal! 011|
tabedit ../mfcalc/calc.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((15 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
